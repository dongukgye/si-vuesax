  ...
  <div id="customizer-panel">
    ...
    >
      <div class="d-flex">
        ...
        <span @click.stop="active = !active" class="cursor-pointer ml-auto"
      ...
      <ul class="clearfix common-list inline-list customizer-list mt-3 mb-4">
        ...
        <li
          @click="topbarColorControl = color"
          v-for="color in themeColors"
          :style="{ backgroundColor: color }"
          :key="color"
        ></li>
        <li
          @click="topbarColorControl = topbarColor"
          :style="{ backgroundColor: topbarColor }"
          :class="{ 'shadow-outline': topbarColor == topbarColorControl }"
        ></li>
        <li>
          <input
            class="input-color"
      ...
      <ul class="clearfix common-list inline-list customizer-list mt-3 mb-4">
        <li
          @click="themeColorControl(color)"
          v-for="color in themeColors"
          :style="{ backgroundColor: color }"
          :key="color"
        ></li>
        <li
          @click="themeColorControl(updatedThemeColor)"
          :style="{ backgroundColor: updatedThemeColor }"
          :class="{ 'shadow-outline': updatedThemeColor == themeColorControl }"
        ></li>
        <li>
          <input
            class="input-color"
            v-model="updatedThemeColor"
            type="color"
            name=""
            value=""
          />
...
export default {
  ...
  computed: {
    topbarColorControl: {
      ...
      set(val) {
        this.$emit("updateTopbarColor", val);
      },
    },
    theme: {
      get() {
    ...
    themeColor: {
      ...
      set(val) {
        this.$store.commit("UPDATE_THEME_COLOR", val);
      },
    },
  },
  methods: {
