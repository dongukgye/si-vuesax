    ...
    >
            ...
            <div>
              ...
              >
                ...
                <a href="javascript:void(0)" class="d-flex align-items-center">
                  <vs-button radius color :class="[mail.btnbg]" type="filled" :icon="mail.btnicon"></vs-button>
      ...
      <vs-dropdown vs-trigger-click left class="cursor-pointer pr-2 pl-2 ml-1 mr-1">
        <a class="text-white-dark" href="#">
          ...
          <span class="dot-count vs-avatar--count badgeNumber dot-count-danger">{{chats.length}}</span>
        </a>
        <vs-dropdown-menu class="topbar-dd common-dd mailbox">
